...
import { View, Text, Modal, TouchableOpacity, StyleSheet, ScrollView, type ViewStyle } from 'react-native'
import Animated, {
  useSharedValue,
  useAnimatedStyle,
  withSpring,
...
export function PremiumDrawer({
  ...
  const handleClose = useCallback(() => {
    if (isTruthy(closeOnBackdropPress)) {
  ...
  const sideStyles: Record<string, ViewStyle> = {
    top: { top: 0, left: 0, right: 0, height: 'auto', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 },
    right: { top: 0, right: 0, bottom: 0, height: '100%', borderTopLeftRadius: 0, borderBottomLeftRadius: 0 },
    bottom: { bottom: 0, left: 0, right: 0, height: 'auto', borderTopLeftRadius: 0, borderTopRightRadius: 0 },
    left: { top: 0, left: 0, bottom: 0, height: '100%', borderTopRightRadius: 0, borderBottomRightRadius: 0 },
  }
