...
export function SmartSkeleton({
  ...
  const skeletonElement = (): React.JSX.Element => {
    switch (variant) {
      case 'circular': {
            ...
            style={[
              baseStyle,
              {
                width:
                  ...
                  '100%',
                height: (typeof height === 'number' ? height : undefined) || 200,
                borderRadius: 8,
              },
            ]}
            ...
            style={[
              baseStyle,
              {
                width:
                  (typeof width === 'number' ? width : width === '100%' ? '100%' : undefined) ||
                  '100%',
                height: (typeof height === 'number' ? height : undefined) || 16,
                borderRadius: 4,
              },
            ]}
            testID={`${testID}-text`}
...
export function PostSkeleton({
  count = 3,
  testID = 'post-skeleton',
}: PostSkeletonProps): React.JSX.Element {
  return (
