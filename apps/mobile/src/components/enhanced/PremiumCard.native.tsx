 ...
 * Location: apps/mobile/src/components/enhanced/PremiumCard.native.tsx
 */
...
export function PremiumCard({
  ...
  const hoverLift = useHoverLift({ scale: 1.02, translateY: -4 })
  ...
  return (
    <AnimatedView
      ...
      onTouchStart={hover ? hoverLift.handleEnter : undefined}
      onTouchEnd={hover ? hoverLift.handleLeave : undefined}
      {...props}
    >
      {children}
    </AnimatedView>
