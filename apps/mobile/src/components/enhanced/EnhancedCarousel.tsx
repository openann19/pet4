 ...
 * Location: apps/mobile/src/components/enhanced/EnhancedCarousel.tsx
 */
...
export function EnhancedCarousel({
  ...
  const containerStyle = useMemo(
    () => StyleSheet.flatten<ViewStyle>([styles.container, style]) ?? styles.container,
    [style]
  )
  ...
  return (
    <GestureHandlerRootView style={containerStyle} {...props}>
