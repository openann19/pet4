...
import { Animated, useSharedValue, withTiming, useAnimatedStyle, withSequence, withDelay } from '@petspark/motion'
...
function ParticleAnimated({ particle }: { particle: Particle }): React.JSX.Element {
