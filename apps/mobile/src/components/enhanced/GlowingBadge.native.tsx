...
const VARIANT_COLORS: Record<GlowingBadgeVariant, { bg: string; text: string; border: string; glow: string }> = {
  primary: { bg: 'rgba(59, 130, 246, 0.1)', text: '#3b82f6', border: 'rgba(59, 130, 246, 0.2)', glow: 'rgba(59, 130, 246, 0.6)' },
  secondary: { bg: 'rgba(100, 116, 139, 0.1)', text: '#64748b', border: 'rgba(100, 116, 139, 0.2)', glow: 'rgba(100, 116, 139, 0.6)' },
  accent: { bg: 'rgba(139, 92, 246, 0.1)', text: '#8b5cf6', border: 'rgba(139, 92, 246, 0.2)', glow: 'rgba(139, 92, 246, 0.6)' },
  success: { bg: 'rgba(34, 197, 94, 0.1)', text: '#22c55e', border: 'rgba(34, 197, 94, 0.2)', glow: 'rgba(34, 197, 94, 0.6)' },
  warning: { bg: 'rgba(234, 179, 8, 0.1)', text: '#eab308', border: 'rgba(234, 179, 8, 0.2)', glow: 'rgba(234, 179, 8, 0.6)' },
}
