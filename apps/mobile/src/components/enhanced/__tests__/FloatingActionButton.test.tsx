...
describe('FloatingActionButton (Mobile)', () => {
  ...
  it('should render with custom icon', () => {
    const { getByText } = render(<FloatingActionButton icon={<Text>Custom</Text>} />)
  ...
  it('should render label when expanded', () => {
    const { getByText } = render(<FloatingActionButton expanded label="Add Item" />)
  ...
  it('should have accessibility props', () => {
    const { getByTestId } = render(<FloatingActionButton label="Add Item" />)
    const button = getByTestId('floating-action-button')
