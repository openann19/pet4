...
import { View, TouchableOpacity, StyleSheet, type ViewStyle, type GestureResponderEvent } from 'react-native'
import Animated, {
  useSharedValue,
  useAnimatedStyle,
  withTiming,
...
export function RippleEffect({
  ...
  const addRipple = useCallback((event: GestureResponderEvent) => {
