 ...
 * Location: apps/mobile/src/components/chat/MessageAttachments.native.tsx
 */
  ...
  return (
    <View style={styles.voiceContainer}>
      ...
      <View style={styles.voiceContent}>
        <View style={styles.waveformContainer} accessibilityRole="image" accessibilityLabel="Audio waveform">
          {waveform.map((value, idx) => (
            <View
              key={idx}
              style={[
                styles.waveformBar,
                { height: Math.max(8, value * 16) },
              ]}
            />
          ))}
        </View>
