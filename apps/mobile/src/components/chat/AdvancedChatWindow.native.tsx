  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
      ...
      <ScrollView ref={scrollRef} style={styles.messages} contentContainerStyle={{ padding: 16 }}>
        {messages.map((msg) => (
          <View key={msg.id} style={[styles.messageRow, msg.senderId === currentUserId ? styles.messageRowSelf : null]}>
            <View style={[styles.messageBubble, msg.senderId === currentUserId ? styles.messageBubbleSelf : null]}>
