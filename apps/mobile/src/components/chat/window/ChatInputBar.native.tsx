...
export function ChatInputBar({
  ...
  const [stickerTab, setStickerTab] = useState<'stickers' | 'reactions'>(
    'stickers'
  )
        ...
        {!isRecordingVoice ? (
          <>
            ...
            <GestureDetector gesture={sendButtonGesture}>
              <AnimatedView style={[styles.sendButtonContainer, sendButtonAnimatedStyle]}>
                <Pressable
            ...
            <View style={styles.stickerHeader}>
              <View style={styles.tabContainer}>
                <Pressable
                  ...
                  style={[
                    styles.tab,
                    stickerTab === 'stickers' && styles.tabActive,
                  ]}
                >
                  <Text
                    style={[
                      styles.tabText,
                      stickerTab === 'stickers' && styles.tabTextActive,
                    ]}
                  >
                    Stickers
                  </Text>
                ...
                <Pressable
                  ...
                  style={[
                    styles.tab,
                    stickerTab === 'reactions' && styles.tabActive,
                  ]}
                >
                  <Text
                    style={[
                      styles.tabText,
                      stickerTab === 'reactions' && styles.tabTextActive,
                    ]}
                  >
                    Reactions
                  </Text>
