...
import MessageAttachments from '../MessageAttachments.native'
...
describe('MessageAttachments (Mobile)', () => {
  ...
  it('should render voice attachment', () => {
    const { getByLabelText } = render(
      <MessageAttachments attachments={[mockVoiceAttachment]} />
    )
  ...
  it('should render photo attachment', () => {
    const { getByLabelText } = render(
      <MessageAttachments attachments={[mockPhotoAttachment]} />
    )
  ...
  it('should render video attachment', () => {
    const { getByText } = render(
      <MessageAttachments attachments={[mockVideoAttachment]} />
    )
  ...
  it('should render document attachment', () => {
    const { getByText } = render(
      <MessageAttachments attachments={[mockDocumentAttachment]} />
    )
  ...
  it('should handle missing attachment name gracefully', () => {
    ...
    const { getByLabelText } = render(
      <MessageAttachments attachments={[attachmentWithoutName]} />
    )
    expect(getByLabelText('Photo attachment')).toBeTruthy()
  })
