 ...
 * 
 * Location: apps/mobile/src/components/chat/PresenceAvatar.native.tsx
 */
...
export function PresenceAvatar({
  ...
  const ringColors =
    status === 'online' ? ['#34d399', '#22d3ee', '#60a5fa'] :
    status === 'away' ? ['#f59e0b', '#fb7185', '#f97316'] :
...
const styles = StyleSheet.create({
  ...
  ringFallback: { position: 'absolute', top: -3, bottom: -3, left: -3, right: -3, borderWidth: 2, borderColor: 'rgba(255,255,255,0.35)' },
