...
function oklchToRgb(l: number, c: number, h: number): { r: number; g: number; b: number } {
  ...
  return {
    r: Math.max(
      ...
      Math.min(
        255,
        Math.round(255 * (r <= 0.0031308 ? 12.92 * r : 1.055 * Math.pow(r, 1 / 2.4) - 0.055))
      )
    ),
    g: Math.max(
      0,
      Math.min(
        255,
        Math.round(255 * (g <= 0.0031308 ? 12.92 * g : 1.055 * Math.pow(g, 1 / 2.4) - 0.055))
      )
    ),
    b: Math.max(
      0,
      Math.min(
        255,
        Math.round(255 * (bl <= 0.0031308 ? 12.92 * bl : 1.055 * Math.pow(bl, 1 / 2.4) - 0.055))
      )
    ),
  };
}
