...
describe('useStickerAnimation', () => {
  ...
  it('should trigger spin animation', () => {
    const { result } = renderHook(() => useStickerAnimation({ animation: 'spin', enabled: true }));
  ...
  it('should trigger pulse animation', () => {
    const { result } = renderHook(() => useStickerAnimation({ animation: 'pulse', enabled: true }));
  ...
  it('should trigger shake animation', () => {
    const { result } = renderHook(() => useStickerAnimation({ animation: 'shake', enabled: true }));
  ...
  it('should trigger float animation', () => {
    const { result } = renderHook(() => useStickerAnimation({ animation: 'float', enabled: true }));
  ...
  it('should trigger grow animation', () => {
    const { result } = renderHook(() => useStickerAnimation({ animation: 'grow', enabled: true }));
  ...
  it('should trigger flip animation', () => {
    const { result } = renderHook(() => useStickerAnimation({ animation: 'flip', enabled: true }));
