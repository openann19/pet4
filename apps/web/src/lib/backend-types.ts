...
export interface ModerationMetrics {
  ...
  averageReviewTime: number
  queueBacklog: number
  topRejectReasons: Array<{ reason: ModerationReason; count: number }>
  reviewsByReviewer: Array<{ reviewerId: string; count: number }>
  kycPassRate: number
...
export interface NotificationPayload {
  userId: string
  type: 'photo_approved' | 'photo_rejected' | 'kyc_required' | 'kyc_approved' | 'kyc_rejected' | 'photo_processing'
  title: string
  message: string
  actionUrl?: string
