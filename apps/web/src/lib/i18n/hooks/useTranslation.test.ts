...
describe('useTranslationFunction', () => {
  ...
  it('should support parameter interpolation', () => {
    ...
    expect(result.current.t('welcome.greeting', { name: 'Jane', count: 5 })).toBe('Hello Jane, you have 5 messages')
  })
...
describe('Translation function edge cases', () => {
  ...
  it('should handle numeric params', () => {
    ...
    expect(result.current.t('welcome.greeting', { name: 'Test', count: 42 })).toBe('Hello Test, you have 42 messages')
  })
