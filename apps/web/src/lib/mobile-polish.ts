...
export const measureTextWidth = (text: string, font = '16px Inter'): number => {
...
export const clampText = (text: string, maxWidth: number, font = '16px Inter'): string => {
...
export const requestIdleCallback = (callback: () => void, timeout = 2000): number => {
