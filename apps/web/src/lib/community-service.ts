...
export const communityService = {
  async getFeed(options: FeedOptions): Promise<FeedResponse> {
    try {
      ...
      logger.error('Failed to get feed', error instanceof Error ? error : new Error(String(error)), { options })
  ...
  async getPost(postId: string): Promise<CommunityPost | undefined> {
    try {
      ...
      logger.error('Failed to get post', error instanceof Error ? error : new Error(String(error)), { postId })
      return undefined
    }
  },
  ...
  async deletePost(postId: string): Promise<void> {
    try {
      ...
      logger.error('Failed to delete post', error instanceof Error ? error : new Error(String(error)), { postId })
      throw error
    }
  },
  ...
  async likePost(postId: string): Promise<Reaction> {
    try {
      ...
      logger.error('Failed to like post', error instanceof Error ? error : new Error(String(error)), { postId })
      throw error
    }
  },
  ...
  async unlikePost(postId: string): Promise<void> {
    try {
      ...
      logger.error('Failed to unlike post', error instanceof Error ? error : new Error(String(error)), { postId })
      throw error
    }
  },
  ...
  async getPostLikes(postId: string): Promise<Reaction[]> {
    try {
      ...
      logger.error('Failed to get post likes', error instanceof Error ? error : new Error(String(error)), { postId })
      return []
    }
  },
  ...
  async isPostLiked(postId: string): Promise<boolean> {
    try {
      ...
      logger.error('Failed to check if post is liked', error instanceof Error ? error : new Error(String(error)), { postId })
      return false
    }
  },
  ...
  async getComments(postId: string, cursor?: string): Promise<Comment[]> {
    try {
      ...
      logger.error('Failed to get comments', error instanceof Error ? error : new Error(String(error)), { postId, cursor })
      return []
    }
  },
  ...
  async savePost(postId: string): Promise<SavedPost> {
    try {
      ...
      logger.error('Failed to save post', error instanceof Error ? error : new Error(String(error)), { postId })
      throw error
    }
  },
  ...
  async unsavePost(postId: string): Promise<void> {
    try {
      ...
      logger.error('Failed to unsave post', error instanceof Error ? error : new Error(String(error)), { postId })
      throw error
    }
  },
  ...
  async getSavedPosts(): Promise<CommunityPost[]> {
    try {
      ...
      logger.error('Failed to get saved posts', error instanceof Error ? error : new Error(String(error)))
      return []
    }
  },
  ...
  async isPostSaved(postId: string): Promise<boolean> {
    try {
      ...
      logger.error('Failed to check if post is saved', error instanceof Error ? error : new Error(String(error)), { postId })
      return false
    }
  },
  ...
  async followUser(targetId: string, targetName: string): Promise<Follow> {
    try {
      ...
      logger.error('Failed to follow user', error instanceof Error ? error : new Error(String(error)), { targetId })
      throw error
    }
  },
  ...
  async unfollowUser(targetId: string): Promise<void> {
    try {
      ...
      logger.error('Failed to unfollow user', error instanceof Error ? error : new Error(String(error)), { targetId })
      throw error
    }
  },
  ...
  async isFollowing(targetId: string, type: 'user' | 'tag' | 'breed' = 'user'): Promise<boolean> {
    try {
      ...
      logger.error('Failed to check following status', error instanceof Error ? error : new Error(String(error)), { targetId, type })
      return false
    }
  },
  ...
  async getTrendingTags(period: 'day' | 'week' | 'month' = 'day'): Promise<string[]> {
    try {
      ...
      logger.error('Failed to get trending tags', error instanceof Error ? error : new Error(String(error)), { period })
      return []
    }
  },
  ...
  async getDrafts(): Promise<PostDraft[]> {
    try {
      ...
      logger.error('Failed to get drafts', error instanceof Error ? error : new Error(String(error)))
      return []
    }
  },
  ...
  async deleteDraft(draftId: string): Promise<void> {
    try {
      ...
      logger.error('Failed to delete draft', error instanceof Error ? error : new Error(String(error)), { draftId })
      throw error
    }
  },
  ...
  async markNotificationRead(notificationId: string): Promise<void> {
    try {
      ...
      logger.error('Failed to mark notification as read', error instanceof Error ? error : new Error(String(error)), { notificationId })
      throw error
    }
  }
}
