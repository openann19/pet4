  ...
  const samplePosts: CommunityPost[] = [
    {
      ...
      kind: 'photo',
      petIds: ['pet-001'],
      text: '🐾 Luna had her first training session today and she was amazing! So proud of my little girl. She learned "sit" and "stay" in just one hour. Any tips for teaching "come" next?',
      media: [
        {
          id: 'img-001',
          type: 'photo',
    ...
    },
    {
      ...
      kind: 'photo',
      petIds: ['pet-002'],
      text: 'Beach day with Max! 🏖️ He discovered that waves are both exciting and scary at the same time 😂 Swipe to see his reaction!',
      media: [
        {
          id: 'img-002',
          type: 'photo',
    ...
    },
    {
      ...
      kind: 'photo',
      petIds: ['pet-003'],
      text: 'Can we talk about how adorable Milo looks in his new sweater? 🧶 Winter is coming and he is READY! #fashionpet #cozyvibes',
      media: [
        {
          id: 'img-004',
          type: 'photo',
    ...
    },
    {
      ...
      kind: 'photo',
      petIds: ['pet-005'],
      text: '❤️ Celebrating 2 years with my rescue kitty, Oliver! From scared shelter cat to confident couch king. Adoption stories are the best stories. #adoptdontshop',
      media: [
        {
          id: 'img-006',
          type: 'photo',
