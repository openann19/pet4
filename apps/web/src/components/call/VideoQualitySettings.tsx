      ...
      <CardContent className="space-y-2">
        ...
        <div className="mt-4 p-4 rounded-lg bg-muted/50 border border-border/50">
          <p className="text-sm text-muted-foreground">
            <strong>Note:</strong> The actual quality may vary based on your device capabilities and
            network conditions. The system will automatically adjust to the best available quality.
          </p>
        </div>
      </CardContent>
    </Card>
