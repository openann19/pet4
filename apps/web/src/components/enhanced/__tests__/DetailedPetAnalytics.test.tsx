...
describe('DetailedPetAnalytics', () => {
  ...
  describe('Compatibility Score Display', () => {
    it('should render compatibility score when provided', () => {
      render(<DetailedPetAnalytics pet={mockPet} compatibilityScore={88} />);
    ...
    it('should render match reasons when provided', () => {
      ...
      render(
        <DetailedPetAnalytics pet={mockPet} compatibilityScore={88} matchReasons={matchReasons} />
      );
    ...
    it('should not render compatibility section when score is not provided', () => {
      render(<DetailedPetAnalytics pet={mockPet} />);
  ...
  describe('Social Stats Display', () => {
    it('should render social stats with trust profile data', () => {
      render(<DetailedPetAnalytics pet={mockPet} trustProfile={mockTrustProfile} />);
  ...
  describe('Rating Distribution', () => {
    ...
    it('should not render rating distribution when no reviews', () => {
      ...
      render(<DetailedPetAnalytics pet={mockPet} trustProfile={noReviewsProfile} />);
  ...
  describe('Personality & Interests', () => {
    ...
    it('should handle pet with no personality traits', () => {
      ...
      render(<DetailedPetAnalytics pet={petNoPersonality} trustProfile={mockTrustProfile} />);
    ...
    it('should handle pet with no interests', () => {
      ...
      render(<DetailedPetAnalytics pet={petNoInterests} trustProfile={mockTrustProfile} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle zero response rate', () => {
      ...
      render(<DetailedPetAnalytics pet={mockPet} trustProfile={zeroResponseProfile} />);
    ...
    it('should handle partial rating breakdown', () => {
      ...
      render(<DetailedPetAnalytics pet={mockPet} trustProfile={partialRatingProfile} />);
