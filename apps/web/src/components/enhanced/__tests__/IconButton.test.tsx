...
describe('IconButton', () => {
  ...
  it('applies ghost variant', () => {
    const { container } = render(<IconButton icon={mockIcon} variant="ghost" aria-label="Test Button" />)
  ...
  it('applies outline variant', () => {
    const { container } = render(<IconButton icon={mockIcon} variant="outline" aria-label="Test Button" />)
  ...
  it('applies glass variant', () => {
    const { container } = render(<IconButton icon={mockIcon} variant="glass" aria-label="Test Button" />)
  ...
  it('applies custom className', () => {
    const { container } = render(<IconButton icon={mockIcon} className="custom-class" aria-label="Test Button" />)
