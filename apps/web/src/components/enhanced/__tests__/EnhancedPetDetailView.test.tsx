...
describe('EnhancedPetDetailView', () => {
  ...
  describe('Rendering', () => {
    it('should render pet information correctly', () => {
      render(<EnhancedPetDetailView pet={mockPet} onClose={mockOnClose} />);
    ...
    it('should render photo gallery with single photo', () => {
      ...
      render(<EnhancedPetDetailView pet={petWithSinglePhoto} onClose={mockOnClose} />);
    ...
    it('should render compatibility score when provided', () => {
      render(<EnhancedPetDetailView pet={mockPet} onClose={mockOnClose} compatibilityScore={88} />);
    ...
    it('should render match reasons when provided', () => {
      ...
      render(
        <EnhancedPetDetailView pet={mockPet} onClose={mockOnClose} matchReasons={matchReasons} />
      );
  ...
  describe('Photo Gallery Navigation', () => {
    it('should navigate to next photo when right button is clicked', () => {
      ...
      const nextButton = buttons.find(
        (btn) => btn.querySelector('svg') && btn.getAttribute('aria-label') !== 'close'
      );
  ...
  describe('Actions', () => {
    ...
    it('should not render action buttons when showActions is false', () => {
      render(<EnhancedPetDetailView pet={mockPet} onClose={mockOnClose} showActions={false} />);
  ...
  describe('Edge Cases', () => {
    it('should handle pet with no photos', () => {
      ...
      render(<EnhancedPetDetailView pet={petNoPhotos} onClose={mockOnClose} />);
    ...
    it('should handle pet with no personality traits', () => {
      ...
      render(<EnhancedPetDetailView pet={petNoPersonality} onClose={mockOnClose} />);
    ...
    it('should handle pet with no interests', () => {
      ...
      render(<EnhancedPetDetailView pet={petNoInterests} onClose={mockOnClose} />);
    ...
    it('should handle pet with no trust score', () => {
      ...
      render(<EnhancedPetDetailView pet={petNoTrust} onClose={mockOnClose} />);
