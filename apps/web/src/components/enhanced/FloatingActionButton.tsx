...
import { useSharedValue, useAnimatedStyle, withSpring, withRepeat, withTiming, withSequence, withDelay, Easing } from 'react-native-reanimated'
  ...
  const buttonStyle = useAnimatedStyle(() => {
    return {
      transform: [
        ...
        { rotate: `${String(rotate.value + hoverRotate.value ?? '')}deg` }
      ],
