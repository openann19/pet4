...
export function AnimatedCard({
  ...
  const containerStyle: CSSProperties = {
    transform: `scale(${String(currentScale ?? '')}) translateY(${String(currentTranslateY ?? '')}px)`,
  ...
  return (
    <div
      className={cn(
        ...
        isClickable && 'cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-xl',
        className
      )}
