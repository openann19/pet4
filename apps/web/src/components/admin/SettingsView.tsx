...
export default function SettingsView() {
  ...
  const handleFeatureFlagChange = useCallback(
    (key: keyof FeatureFlags, value: boolean): void => {
      try {
  ...
  const handleSystemSettingChange = useCallback(
    (key: keyof SystemSettings, value: number | boolean): void => {
      try {
        triggerHaptic('light');
              ...
              <CardContent className="space-y-6">
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleFeatureFlagChange('enableChat', checked)
                  }
                />
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleFeatureFlagChange('enableVisualAnalysis', checked)
                  }
                />
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleFeatureFlagChange('enableMatching', checked)
                  }
                />
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleFeatureFlagChange('enableReporting', checked)
                  }
                />
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleFeatureFlagChange('enableVerification', checked)
                  }
                />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleSystemSettingChange('autoModeration', checked)
                  }
                />
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleSystemSettingChange('requireVerification', checked)
                  }
                />
                ...
                <FeatureFlagItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleSystemSettingChange('messagingEnabled', checked)
                  }
                />
              </CardContent>
            </Card>
          ...
          >
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <InfoRow
                  label="Build"
                  value={new Date().toISOString().split('T')[0] ?? new Date().toISOString()}
                />
              </CardContent>
            </Card>
          </AnimatedView>
