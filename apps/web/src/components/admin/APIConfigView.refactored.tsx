      ...
      <ScrollArea className="flex-1">
        <div className="container mx-auto px-6 py-8 space-y-8 max-w-6xl">
          ...
          <Tabs defaultValue="maps" className="space-y-6">
            ...
            {/* Additional sections would use similar patterns */}
            {/* For now, keeping some sections in the original format due to complexity */}
            {/* This demonstrates the refactoring pattern that can be applied to all sections */}
          </Tabs>
        </div>
      </ScrollArea>
    </div>
