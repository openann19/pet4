...
vi.mock('./MapLocationPicker', () => ({
  MapLocationPicker: ({ onSelect, onClose }: { onSelect: (lat: number, lon: number) => void; onClose: () => void }) => (
    <div data-testid="map-location-picker">
      <button onClick={() => { onSelect(40.7128, -74.0060); }}>Select Location</button>
