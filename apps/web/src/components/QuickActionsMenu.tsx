        ...
        >
          {actions.map((action, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-full bg-linear-to-br ${String(action.color ?? '')} flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-shadow`}
                >
                  {action.icon}
                </div>
