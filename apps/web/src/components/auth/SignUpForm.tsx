        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 h-12 ${String(errors.name ? 'border-destructive' : '' ?? '')}`}
              disabled={isLoading}
              autoComplete="name"
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 h-12 ${String(errors.email ? 'border-destructive' : '' ?? '')}`}
              disabled={isLoading}
              autoComplete="email"
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 pr-12 h-12 ${String(errors.password ? 'border-destructive' : '' ?? '')}`}
              disabled={isLoading}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 pr-12 h-12 ${String(errors.confirmPassword ? 'border-destructive' : '' ?? '')}`}
              disabled={isLoading}
              autoComplete="new-password"
            />
            <button
