 ...
 */
export default function HoloBackground({ intensity = 0.6, className = '' }: HoloBackgroundProps) {
    ...
    if (!enableHoloBackground || reducedMotion) {
      ...
      if (c) {
        ...
        if (g) {
          ...
          grad.addColorStop(0, `rgba(160,180,255,${0.35 * intensity})`);
          grad.addColorStop(0.5, `rgba(120,80,255,${0.25 * intensity})`);
