    ...
    >
      <Card className="p-12 bg-background/60 backdrop-blur-md border-border/40 shadow-lg rounded-2xl">
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <h3 className={getTypographyClasses('h2')}>No Applications Yet</h3>
          <p className={cn(getTypographyClasses('body'), 'text-muted-foreground max-w-md')}>
            Your adoption applications will appear here. Browse available pets and submit applications to find your perfect companion.
          </p>
        </div>
      </Card>
    </MotionView>
