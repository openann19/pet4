          ...
          <div className="relative h-80 bg-muted">
            <Presence mode="wait">
              <motion.img
                ...
                alt={`${String(profile.petName ?? '')} - Photo ${String(currentPhotoIndex + 1 ?? '')}`}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    String(profile.vaccinated ? 'bg-green-500/10' : 'bg-gray-500/10' ?? '')
                  }`}>
                    {profile.vaccinated ? (
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    String(profile.spayedNeutered ? 'bg-green-500/10' : 'bg-gray-500/10' ?? '')
                  }`}>
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    String(profile.goodWithKids ? 'bg-green-500/10' : 'bg-gray-500/10' ?? '')
                  }`}>
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    String(profile.goodWithPets ? 'bg-green-500/10' : 'bg-gray-500/10' ?? '')
                  }`}>
