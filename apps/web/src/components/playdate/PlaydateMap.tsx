                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-2xl mx-auto">
                    {playdatesWithLocation.slice(0, 6).map((playdate, index) => {
                      ...
                      return (
                        ...
                        >
                          <Card
                            className={`p-3 cursor-pointer hover:shadow-lg transition-all ${String(selectedPlaydate?.id === playdate.id
          ...
          <div className="space-y-3">
            {playdatesWithLocation.map((playdate, index) => {
              ...
              return (
                ...
                >
                  <Card
                    className={`p-4 cursor-pointer hover:shadow-lg transition-all ${String(selectedPlaydate?.id === playdate.id
                      ? 'ring-2 ring-primary bg-primary/5'
                      : 'hover:bg-accent/5')
                      }`}
                    onClick={() => { handleSelectPlaydate(playdate); }}
          ...
          >
            <Card className="p-4 shadow-2xl border-2 border-primary/20 bg-card/98 backdrop-blur-lg">
              <div className="flex items-start justify-between mb-3">
                ...
                <Button variant="ghost" size="icon" onClick={() => setSelectedPlaydate(null)} aria-label="Close playdate details">
                  <X size={20} />
                </Button>
              </div>
