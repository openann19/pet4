...
describe('Deterministic Seeds', () => {
  ...
  describe('ConfettiBurst', () => {
    it('should remount with different particle count when seed changes', () => {
      ...
      const initialParticles = container.querySelectorAll('[data-testid="confetti-particle"]').length
      ...
      rerender(
        <ConfettiBurst enabled={true} seed="seed-2" particleCount={50} />
      )
  ...
  describe('ReactionBurstParticles', () => {
    it('should remount when seed changes', () => {
      ...
      rerender(
        <ReactionBurstParticles enabled={true} seed="seed-2" count={10} />
      )
  ...
  describe('LiquidDots', () => {
    ...
    it('should use instant fallback when reduced motion is enabled', () => {
      ...
      const { container } = render(
        <LiquidDots enabled={true} seed="test" />
      )
