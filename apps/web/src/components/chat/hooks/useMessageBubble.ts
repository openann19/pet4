...
export interface UseMessageBubbleReturn {
  ...
  deliveryTransition: ReturnType<typeof useMessageDeliveryTransition>;
...
export function useMessageBubble({
  ...
  return {
    ...
    reactionsPickerOpacity: reactionsPickerOpacity as ReturnType<typeof useSharedValue<string | number>>,
    reactionsPickerScale: reactionsPickerScale as ReturnType<typeof useSharedValue<string | number>>,
    reactionsPickerTranslateY: reactionsPickerTranslateY as ReturnType<typeof useSharedValue<string | number>>,
