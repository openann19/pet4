...
export function VerificationLevelSelector({
  ...
  const levels: { level: VerificationLevel; icon: typeof Shield; color: string; title: string }[] = [
    { level: 'basic', icon: Shield, color: 'from-blue-500/20 to-cyan-500/20 border-blue-500/30', title: 'Basic' },
    { level: 'standard', icon: ShieldCheck, color: 'from-purple-500/20 to-pink-500/20 border-purple-500/30', title: 'Standard' },
    { level: 'premium', icon: ShieldStar, color: 'from-amber-500/20 to-orange-500/20 border-amber-500/30', title: 'Premium' }
  ]
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-2 mb-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {requirements.requiredDocuments.length} required document{requirements.requiredDocuments.length !== 1 ? 's' : ''}
                  </p>
                </div>
