            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  {t.map?.preciseExpires || `Expires in ${String(Math.ceil((preciseSharingUntil - Date.now()) / 60000) ?? '')} minutes`}
                </p>
              </div>
              <Button
                size="sm"
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        haptics.trigger('medium');
                        const url = `https://www.google.com/maps/dir/?api=1&destination=${String(place.location.lat ?? '')},${String(place.location.lng ?? '')}`;
