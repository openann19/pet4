...
describe('useScrollToNew', () => {
  ...
  it('should handle scroll without container ref', () => {
    ...
    const { result } = renderHook(() => useScrollToNew({ targetRef }));
  ...
  it('should not scroll multiple times simultaneously', () => {
    ...
    const { result } = renderHook(() => useScrollToNew({ containerRef, targetRef }));
  ...
  it('should animate chip on visibility change', () => {
    const { result, rerender } = renderHook(({ isVisible }) => useScrollToNew({ isVisible }), {
