...
describe('useMatches', () => {
  ...
  it('should fetch matches for pet', async () => {
    const mockPets = [
      {
        ...
        photos: [{ id: 'photo-1', url: 'https://example.com/photo.jpg', thumbnailUrl: 'https://example.com/thumb.jpg', order: 0, uploadedAt: new Date().toISOString() }],
    ...
    const mockMatchedPet = {
      ...
      photos: [{ id: 'photo-2', url: 'https://example.com/photo2.jpg', thumbnailUrl: 'https://example.com/thumb2.jpg', order: 0, uploadedAt: new Date().toISOString() }],
