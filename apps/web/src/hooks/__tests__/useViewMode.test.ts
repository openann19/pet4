...
describe('useViewMode', () => {
  ...
  it('calls onModeChange callback', () => {
    ...
    const { result } = renderHook(() =>
      useViewMode({ onModeChange: mockOnModeChange })
    )
  ...
  it('does not set unavailable mode', () => {
    const { result } = renderHook(() =>
      useViewMode({ availableModes: ['cards', 'map'] })
    )
  ...
  it('cycles through all available modes', () => {
    const { result } = renderHook(() =>
      useViewMode({ availableModes: ['cards', 'map', 'list'] })
    )
  ...
  it('handles single available mode', () => {
    const { result } = renderHook(() =>
      useViewMode({ availableModes: ['cards'] })
    )
