...
describe('useAITypingReveal', () => {
  ...
  it('should initialize with default values', () => {
    const { result } = renderHook(() =>
      useAITypingReveal({ text: 'Hello', enabled: false })
    )
  ...
  it('should reset state', () => {
    const { result } = renderHook(() =>
      useAITypingReveal({ text: 'Test', enabled: false })
    )
  ...
  it('should handle empty text', () => {
    const { result } = renderHook(() =>
      useAITypingReveal({ text: '', enabled: true })
    )
  ...
  it('should call start manually', async () => {
    const { result } = renderHook(() =>
      useAITypingReveal({ text: 'Manual', enabled: false })
    )
