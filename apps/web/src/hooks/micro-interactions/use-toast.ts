 ...
 */
export function useToastAnimation(options: UseToastAnimationOptions): UseToastAnimationReturn {
  ...
  }, [toast, translateY, opacity, scale, progress, reducedMotion, onDismissComplete]);
  ...
  const animatedStyle = useAnimatedStyle(() => {
    ...
    return {
      transform: `translateY(${translateY.value + yOffset}px) scale(${scale.value})`,
