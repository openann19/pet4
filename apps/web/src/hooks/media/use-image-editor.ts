...
export function useImageEditor(
  ...
  const applyCanvasFilter = useCallback(
    (ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement, filter: FilterType) => {
  ...
  const applyCanvasAdjustments = useCallback(
    (
