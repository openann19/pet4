...
describe('useParticleExplosionDelete', () => {
  ...
  it('should use custom colors for explosion', () => {
    ...
    const { result } = renderHook(() => useParticleExplosionDelete({ colors: customColors }));
  ...
  it('should use explosion-specific colors when provided', () => {
    ...
    const { result } = renderHook(() => useParticleExplosionDelete({ colors: defaultColors }));
  ...
  it('should respect custom particle count', () => {
    const { result } = renderHook(() => useParticleExplosionDelete({ particleCount: 5 }));
  ...
  it('should not trigger explosion when disabled', () => {
    const { result } = renderHook(() => useParticleExplosionDelete({ enabled: false }));
