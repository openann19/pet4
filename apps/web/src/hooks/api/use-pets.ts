 ...
 */
export function useCreatePet(): UseMutationResult<Pet, unknown, CreatePetData> {
 ...
 */
export function useUpdatePet(): UseMutationResult<Pet, unknown, { id: string; data: UpdatePetData }> {
  const queryClient = useQueryClient()
 ...
 */
export function useDeletePet(): UseMutationResult<{ success: boolean }, unknown, string> {
  const queryClient = useQueryClient()
