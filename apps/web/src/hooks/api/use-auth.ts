 ...
 * Hook to login
 */
export function useLogin(): UseMutationResult<AuthResponse, unknown, LoginCredentials> {
 ...
 * Hook to signup
 */
export function useSignup(): UseMutationResult<AuthResponse, unknown, SignupData> {
  const queryClient = useQueryClient()
 ...
 * Hook to logout
 */
export function useLogout(): UseMutationResult<{ success: boolean }, unknown, void> {
  const queryClient = useQueryClient()
