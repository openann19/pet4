...
const SENTIMENT_PATTERNS = {
  positive: [
    'happy', 'love', 'great', 'amazing', 'wonderful', 'excited', 'joy',
    'fantastic', 'perfect', 'brilliant', 'excellent', 'smile', 'laugh',
    'haha', 'yay', 'woohoo', 'yes', 'yep', 'sure', 'definitely', 'absolutely'
  ],
  negative: [
    'sad', 'angry', 'upset', 'bad', 'terrible', 'awful', 'hate',
    'disappointed', 'frustrated', 'worried', 'anxious', 'stressed',
    'no', 'nope', 'never', 'stop', 'wrong', 'error', 'problem', 'issue'
  ]
}
