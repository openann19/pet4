...
export type {
  Use3DTiltEffectOptions,
  Use3DTiltEffectReturn
} from './effects/use3DTiltEffect'
...
export type {
  UseSoundFeedbackOptions,
  UseSoundFeedbackReturn
} from './effects/useSoundFeedback'
...
export type {
  UseEmojiTrailOptions,
  UseEmojiTrailReturn
} from './effects/useEmojiTrail'

// Legacy exports (for backward compatibility)
export * from './effects/useParticleFX'
export type {
  UseParticleFXOptions,
  UseParticleFXReturn,
  Particle
} from './effects/useParticleFX'

export * from './effects/useMoodTheme'
export type {
  UseMoodThemeOptions,
  UseMoodThemeReturn
} from './effects/useMoodTheme'
