...
VITE*STRIPE_PUBLIC_KEY=pk_live*...your-stripe-public-key
...
// External Services
VITE*MAPBOX_TOKEN: z.string().startsWith('pk.', 'Invalid Mapbox token'),
VITE_STRIPE_PUBLIC_KEY: z.string().startsWith('pk*', 'Invalid Stripe public key'),
...
const limits = {
image: { maxSize: 10 _ 1024 _ 1024, types: ['image/jpeg', 'image/png', 'image/webp'] },
video: { maxSize: 100 _ 1024 _ 1024, types: ['video/mp4', 'video/webm'] },
document: { maxSize: 5 _ 1024 _ 1024, types: ['application/pdf', 'image/jpeg', 'image/png'] }
}
...
const maxSize = 10 _ 1024 _ 1024 // 10MB
...
private readonly CACHE*DURATION = 5 * 60 \_ 1000 // 5 minutes
...
run: |
echo "Deploying to staging environment..." # Add your deployment script here # kubectl set image deployment/pawfectmatch pawfectmatch=${{ needs.build.outputs.image-tag }}
...
run: |
echo "Deploying to production environment..." # Add your production deployment script here
