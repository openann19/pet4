...
describe('Deep Linking System', () => {
  ...
  describe('Route Parsing', () => {
    it('should parse URL with path parameters', () => {
      ...
      window.location.href = 'https://pawfectmatch.app/chat/123'
      window.location.pathname = '/chat/123'
      manager['handleCurrentUrl']()
    ...
    it('should parse query parameters', () => {
      ...
      window.location.href = 'https://pawfectmatch.app/chat/123?messageId=456'
      window.location.pathname = '/chat/123'
      window.location.search = '?messageId=456'
      window.location.searchParams = new URLSearchParams('messageId=456')
      manager['handleCurrentUrl']()
