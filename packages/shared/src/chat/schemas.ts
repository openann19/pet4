...
export const messageTypeSchema = z.enum(['text', 'image', 'video', 'voice', 'location', 'sticker', 'pet-card'])
...
export const messageSchema = z.object({
  ...
  reactions: z.union([
    z.array(messageReactionSchema),
    z.record(reactionTypeSchema, z.array(z.string())),
  ]).optional(),
