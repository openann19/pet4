...
import { useReducedMotion, useReducedMotionSV, getReducedMotionDuration, getReducedMotionMultiplier } from './reduced-motion';
...
describe('useReducedMotionSV', () => {
  it('should return SharedValue that updates reactively', () => {
    window.matchMedia = vi.fn().mockImplementation(() => ({
      matches: false,
      addEventListener: vi.fn(),
      removeEventListener: vi.fn(),
